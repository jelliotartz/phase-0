...
# The difference was that you can use two variables when using .each
# on the hash. The hash portion was definitely harder as I had to
# return an array. But just creating an empty array and appending the
# key to the new array helped.

# Share any tricks you used to find and decipher the Ruby Docs

# Checking Ruby Docs for methods on the array page and the hash page
# showed me what methods can be applied. I basically went through each
# of the examples on those pages that made the most sense to me.
#
#
