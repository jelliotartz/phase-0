...
Or, for that matter, how it knows when to insert a #. It seems like
whenever y increases, x must increase as well... but this can't be
true, because then x + y would always be even, and thus x + y % 2
would always == 0. I guess there's something about the for loop within
the for loop that I'm not understanding yet, that allows both of these
things (insert # after space, and put the new line at the correct
position) to happen.
